  ...
  const partners = [
    {
      ...
      descriptionKo:
        "인천광역시 남동구 제휴 한의원. 체질·다이어트·통증 한방 케어, 동남아 VIP 전담 상담 연계.",
      descriptionEn:
        "Partner oriental clinic in Namdong-gu, Incheon. Constitution, diet, and pain care with VIP SEA coordination.",
      descriptionId:
        "Klinik oriental mitra di Namdong-gu, Incheon. Perawatan konstitusi, diet, dan nyeri dengan koordinator VIP ASEAN.",
      provinceKey: "incheon",
      cityKey: null,
      districtKey: "namdong",
    ...
    },
    {
      ...
      descriptionKo:
        "인천광역시 부평구 세란성형외과. 눈·코·안면윤곽 VIP 상담 및 수술 패키지.",
      descriptionEn:
        "Seran Plastic Surgery in Bupyeong-gu, Incheon. VIP consults for eyes, nose, and facial contouring.",
      descriptionId:
        "Seran Plastic Surgery di Bupyeong-gu, Incheon. Konsultasi VIP untuk mata, hidung, dan kontur wajah.",
      provinceKey: "incheon",
      cityKey: null,
      districtKey: "bupyeong",
    ...
    },
    {
      ...
      descriptionKo:
        "인천광역시 부평구 세란플러스성형외과. 리프팅·지방흡입·바디 라인 맞춤 상담.",
      descriptionEn:
        "Seran Plus in Bupyeong-gu, Incheon. Custom consults for lifting, liposuction, and body contouring.",
      descriptionId:
        "Seran Plus di Bupyeong-gu, Incheon. Konsultasi khusus untuk lifting, sedot lemak, dan kontur tubuh.",
      provinceKey: "incheon",
      cityKey: null,
      districtKey: "bupyeong",
      primaryCategory: MedicalCategory.PLASTIC,
    ...
    },
    {
      ...
      descriptionKo:
        "인천광역시 부평구 세란피부과. 레이저·보톡스·필러 프리미엄 시술 패키지.",
      descriptionEn:
        "Seran Dermatology in Bupyeong-gu, Incheon. Premium laser, Botox, and filler packages.",
      descriptionId:
        "Seran Dermatology di Bupyeong-gu, Incheon. Paket premium laser, Botox, dan filler.",
      provinceKey: "incheon",
      cityKey: null,
      districtKey: "bupyeong",
    ...
    },
    {
      ...
      descriptionKo:
        "인천광역시 부평구 세란치과. 임플란트·심미 치료, 통역 동행 상담 연계.",
      descriptionEn:
        "Seran Dental in Bupyeong-gu, Incheon. Implants and cosmetic dentistry with interpreter support.",
      descriptionId:
        "Seran Dental di Bupyeong-gu, Incheon. Implan dan estetika gigi dengan pendamping penerjemah.",
      provinceKey: "incheon",
      cityKey: null,
      districtKey: "bupyeong",
